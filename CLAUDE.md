...
This project evaluates **Binoculars** (ICML 2024) as a zero-shot detector for AI-generated text in NIH grant applications. It runs locally on Mac Studio using Apple MPS (Metal) acceleration.
